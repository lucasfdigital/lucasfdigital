...
const lucas = {
  base: "Fortaleza, CE ☀️",
  atual: "Líder de Desenvolvimento @ ESCALE BIZ",
  faço: ["Sales Ops", "Growth", "CRM", "Automação", "IA"],
  missão: "transformar atração de clientes em receita previsível",
  manias: ["processo bem desenhado", "dado limpo", "café"],
  status: "provavelmente automatizando algo agora mesmo",
};
```
...
Quem já trabalhou comigo costuma resumir assim: deixo os processos mais inteligentes, entrego no nível técnico **e** ainda mantenho o clima leve no escritório. Eficiência sem precisar ser chato. 😎
